...
@Component({
  selector: 'app-pago-otras-monedas',
  templateUrl: './pago-otras-monedas.component.html',
  styleUrls: ['./pago-otras-monedas.component.css']
})
export class PagoOtrasMonedasComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<PagoOtrasMonedasComponent>, @Inject(MAT_DIALOG_DATA) public data,
