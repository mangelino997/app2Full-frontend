...
export class SindicatoComponent implements OnInit {
  ...
  public columnas: string[] = ['id', 'nombre', 'sitioWeb', 'ver', 'mod'];
  //Define la matSort
  @ViewChild(MatSort) sort: MatSort;
  //Constructor
  constructor(private servicio: SindicatoService, private subopcionPestaniaService: SubopcionPestaniaService,
