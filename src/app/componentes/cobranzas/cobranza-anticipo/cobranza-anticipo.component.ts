...
@Component({
  selector: 'app-cobranza-anticipo',
  templateUrl: './cobranza-anticipo.component.html',
  styleUrls: ['./cobranza-anticipo.component.css']
})
export class CobranzaAnticipoComponent implements OnInit {
