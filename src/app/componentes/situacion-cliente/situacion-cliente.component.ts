...
@Component({
  ...
  templateUrl: './situacion-cliente.component.html',
  styleUrls: ['./situacion-cliente.component.css']
})
export class SituacionClienteComponent implements OnInit {
  ...
  //Constructor
  constructor(private servicio: SituacionClienteService, private subopcionPestaniaService: SubopcionPestaniaService,
