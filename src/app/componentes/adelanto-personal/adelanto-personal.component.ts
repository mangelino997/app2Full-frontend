...
export class AdelantoPersonalComponent implements OnInit {
  ...
  private calcularImporteDisponible(){
    ...
    console.log(topeBasicoAdelanto, basico);
  ...
  public controlarImporte(){
    ...
    importeDisponible = this.importeDisponible.value;
...
export class PrestamoDialogo {
  ...
  @ViewChild(MatSort) sort: MatSort;
  //Constructor
  constructor(public dialogRef: MatDialogRef<PrestamoDialogo>, @Inject(MAT_DIALOG_DATA) public data) { }
