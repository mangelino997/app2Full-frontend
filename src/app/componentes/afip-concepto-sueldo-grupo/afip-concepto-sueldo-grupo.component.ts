...
import { AfipConceptoSueldoGrupo } from 'src/app/modelos/afipConceptoSueldoGrupo';

@Component({
  selector: 'app-afip-concepto-sueldo-grupo',
  templateUrl: './afip-concepto-sueldo-grupo.component.html',
  styleUrls: ['./afip-concepto-sueldo-grupo.component.css']
})
export class AfipConceptoSueldoGrupoComponent implements OnInit {
  //Define el ultimo id
  ...
  public resultadosTipoCptoSueldos: Array<any> = [];
  ...
  public columnas: string[] = ['ID', 'TIPO_CONCEPTO', 'NOMBRE', 'EDITAR'];
  //Define la matSort
  @ViewChild(MatSort, { static: false }) sort: MatSort;
  //Define la paginacion
  @ViewChild(MatPaginator, { static: false }) paginator: MatPaginator;
  //Constructor
  constructor(private servicio: AfipConceptoSueldoGrupoService, private appService: AppService, private modelo: AfipConceptoSueldoGrupo,
  ...
  private inicializar(idRol, idSubopcion) {
    ...
    this.servicio.inicializar(idRol, idSubopcion).subscribe(
      res => {
        ...
        this.resultadosTipoCptoSueldos = respuesta.tipoConceptoSueldos;
        this.render = false;
      },
      err => {
