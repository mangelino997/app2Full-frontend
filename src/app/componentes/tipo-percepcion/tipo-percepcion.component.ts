...
@Component({
  selector: 'app-tipo-percepcion',
  templateUrl: './tipo-percepcion.component.html',
  styleUrls: ['./tipo-percepcion.component.css']
})
export class TipoPercepcionComponent implements OnInit {
  ...
  constructor(private servicio: TipoPercepcionService, private subopcionPestaniaService: SubopcionPestaniaService,
    private appService: AppService, private toastr: ToastrService, private loaderService: LoaderService, private tipoPercepcion: TipoPercepcion) {
