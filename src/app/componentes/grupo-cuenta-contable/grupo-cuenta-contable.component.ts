...
export class GrupoCuentaContableComponent implements OnInit {
  ...
  constructor(private servicio: GrupoCuentaContableService, private subopcionPestaniaService: SubopcionPestaniaService,
    private grupoCuentaContable: GrupoCuentaContable, private tipoCuentaContableService: TipoCuentaContableService,
  ...
  private listarTiposCuentaContable() {
    this.tipoCuentaContableService.listar().subscribe(
      res => {
        this.tiposCuentaContable = res.json();
      },
      err => {
        console.log(err);
      }
