...
const routes: Routes = [
    ...
    { path: 'configuraciontiposdeconceptosventa', loadChildren: () => import('./modulos/tipo-concepto-venta/tipo-concepto-venta.module').then(m => m.VentaConceptoModule), canActivate: [GuardiaService] },
