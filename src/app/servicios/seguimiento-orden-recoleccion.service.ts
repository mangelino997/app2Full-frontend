...
@Injectable()
export class SeguimientoOrdenRecoleccionService {
  //Define la ruta al servicio web
  private ruta: string = "/seguimientoordenrecoleccion";
  //Define la url base
  ...
  public listarPorOrdenRecoleccion(idRecoleccion) {
    return this.http.get(this.url + '/listarPorOrdenRecoleccion/' + idRecoleccion, this.options);
  }
