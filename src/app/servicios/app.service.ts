...
export class AppService {
  ...
  // private URL_ORIGEN = 'https://jit-gestion.appspot.com'; //RIGAR
  // private URL_ORIGEN = 'https://jit-ute.appspot.com'; //UTE
  private URL_ORIGEN = 'http://localhost:4200'; //LOCALHOST
  //Define la IP
  // private IP = 'https://gestionws.appspot.com'; //RIGAR
  // private IP = 'https://jitws-ute.appspot.com'; //UTE
  private IP = 'http://localhost:8080'; //LOCALHOST
  //Define la url base
