...
export class PagoAnticipoService {
  //Define la ruta al servicio web
  private ruta:string = "/pagoanticipo";
  //Define la url base
  ...
  public listarPorPago(idPago) {
    return this.http.get(this.url + '/listarPorPago/' + idPago, this.options);
  }
  //Obtiene la lista de registros
  public listarPorProveedorYSaldoMayorCero(idProveedor) {
    return this.http.get(this.url + '/listarPorProveedorYSaldoMayorCero/' + idProveedor, this.options);
  }
  //Agrega un registro
