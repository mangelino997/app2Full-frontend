...
export class BasicoCategoriaService {
//Define la ruta al servicio web
private ruta:string = "/basicocategoria";
//Define la url base
...
public listarPorCategoriaNombre(nombre) {
  return this.http.get(this.url + '/listarPorCategoriaNombre/' + nombre, this.options).map(res => {
