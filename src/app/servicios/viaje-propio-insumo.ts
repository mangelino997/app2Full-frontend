...
@Injectable()
export class ViajePropioInsumoService {
  //Define la ruta al servicio web
  private ruta:string = "/viajepropioinsumo";
  //Define la url base
  ...
  //Obtiene la lista de insumos por viaje propio
  public listarInsumos(idViajePropio) {
    return this.http.get(this.url + '/listarInsumos/' + idViajePropio, this.options);
  }
  //Agrega un registro
