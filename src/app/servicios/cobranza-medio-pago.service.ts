...
@Injectable()
export class CobranzaMedioPagoService {
  //Define la ruta al servicio web
  private ruta:string = "/cobranzamediopago";
  //Define la url base
  ...
  //Obtiene registros por idCobranza
  public listarPorCobranza(idCobranza) {
    return this.http.get(this.url + '/listarPorCobranza/' + idCobranza, this.options);
  }
  //Agrega lote de registros
  public agregarLote(elementos) {
    return this.http.post(this.url + '/agregarLote', elementos, this.options);
  }
  //Agrega unregistro
