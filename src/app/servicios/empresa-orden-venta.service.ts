...
@Injectable()
export class EmpresaOrdenVentaService {
  //Define la ruta al servicio web
  private ruta:string = "/empresaordenventa";
  //Define la url base
  ...
  //Obtiene la lista de registros por orden venta
  public listarPorOrdenVenta(idOrdenVenta) {
    return this.http.get(this.url + '/listarPorOrdenVenta/' + idOrdenVenta, this.options);
  }
  //Obtiene la lista de registros por empresa y orden venta
  public listarPorEmpresaYOrdenVenta(idEmpresa, idOrdenVenta) {
    return this.http.get(this.url + '/listarPorEmpresaYOrdenVenta/' + idEmpresa + '/' + idOrdenVenta, this.options);
  }
  //Agrega un registro
