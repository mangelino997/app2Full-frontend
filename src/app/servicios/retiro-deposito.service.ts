...
@Injectable()
export class RetiroDepositoService {
  //Define la ruta al servicio web
  private ruta:string = "/retirodeposito";
  //Define la url base
  ...
  //Obtiene la lista de registros por numero de documento
  public listarPorNumeroDocumento(documento) {
    return this.http.get(this.url + '/listarPorNumeroDocumento/' + documento, this.options);
  }
