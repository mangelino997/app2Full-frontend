...
@Injectable()
export class SeguimientoEstadoService {
  //Define la ruta al servicio web
  private ruta: string = "/seguimientoestado";
  //Define la url base
  ...
  public listarParaReparto() {
    return this.http.get(this.url + '/listarParaReparto', this.options);
  }
  //Obtiene una lista para Reparto Entrante
  public listarParaRepartoEntrante() {
    return this.http.get(this.url + '/listarParaRepartoEntrante', this.options);
  }
  //Agrega un registro
