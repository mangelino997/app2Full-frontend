...
export class MedioPagoService {
  ...
  public listarParaIngreso() {
    return this.http.get(this.url + '/listarParaIngreso', this.options);
  }
  //Obtiene una lista por habilitados para egreso
  public listarParaEgreso() {
    return this.http.get(this.url + '/listarParaEgreso', this.options);
  }
