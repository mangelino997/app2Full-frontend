...
@Injectable()
export class AfipDeduccionPersonalService {
  //Define la ruta al servicio web
  private ruta: string = "/afipdeduccionpersonal";
  //Define la url base
  ...
  //Obtiene todos los listados
  public inicializarTabla(idRol, idSubopcion) {
    return this.http.get(this.url + '/inicializarTabla/' + idRol + '/' + idSubopcion, this.options);
  }
  //Agrega un registro
