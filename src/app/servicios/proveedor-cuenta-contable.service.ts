...
@Injectable()
export class ProveedorCuentaContableService {
  //Define la ruta al servicio web
  private ruta:string = "/proveedorcuentacontable";
  //Define la url base
  ...
  //Obtiene la lista de registros por plan de cuenta
  ...
  public listarPorProveedor(idProveedor) {
    return this.http.get(this.url + '/listarPorProveedor/' + idProveedor);
  }
  //Agrega un registro
