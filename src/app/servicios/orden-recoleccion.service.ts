...
export class OrdenRecoleccionService {
  ...
  private ruta: string = "/ordenrecoleccion";
  //Define la url base
  ...
  public listarPorFiltros(fechaEmision, idCliente) {
    return this.http.get(this.url + '/listarPorFiltros/' + fechaEmision + '/' + idCliente , this.options);
  }
  //Obtiene la lista de registros
