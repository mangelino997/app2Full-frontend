...
@Injectable()
export class SeguimientoVentaComprobanteService {
  //Define la ruta al servicio web
  private ruta: string = "/seguimientoventacomprobante";
  //Define la url base
  ...
  //Obtiene una lista por Venta Comprobante
  public listarPorVentaComprobante(idVentaComprobante) {
    return this.http.get(this.url + '/listarPorVentaComprobante/' + idVentaComprobante, this.options);
  }
