...
var MonedaService = /** @class */ (function () {
    //Constructor
    function MonedaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    MonedaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    MonedaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un registros por nombre
    MonedaService.prototype.listarPorNombre = function (nombre) {
        return this.http.get(this.url + '/listarPorNombre/' + nombre, this.options);
    };
    //Obtiene por Defecto (obtiene la moneda principal)
    MonedaService.prototype.obtenerPorDefecto = function () {
        return this.http.get(this.url + '/obtenerPorDefecto', this.options);
    };
    //Agrega un registro
    MonedaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    MonedaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Setea una moneda como principal
    MonedaService.prototype.establecerMonedaPrincipal = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    MonedaService.prototype.eliminar = function (id) {
