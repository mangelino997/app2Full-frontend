...
var OpcionService = /** @class */ (function () {
    //Constructor
    function OpcionService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    OpcionService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    OpcionService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    OpcionService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    OpcionService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    OpcionService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    OpcionService.prototype.eliminar = function (id) {
...
//# sourceMappingURL=opcion.service.js.map