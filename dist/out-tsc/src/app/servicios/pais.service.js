...
var PaisService = /** @class */ (function () {
    //Constructor
    function PaisService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    PaisService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    PaisService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    PaisService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    PaisService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    PaisService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    PaisService.prototype.eliminar = function (id) {
