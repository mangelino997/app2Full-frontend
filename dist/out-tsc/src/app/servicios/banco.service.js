...
var BancoService = /** @class */ (function () {
    //Constructor
    function BancoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    BancoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    BancoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    BancoService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    BancoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    BancoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    BancoService.prototype.eliminar = function (id) {
