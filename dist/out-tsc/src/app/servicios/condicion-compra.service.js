...
var CondicionCompraService = /** @class */ (function () {
    //Constructor
    function CondicionCompraService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/condicioncompra";
        //Define la url base
        this.url = null;
    ...
    CondicionCompraService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    CondicionCompraService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    CondicionCompraService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    CondicionCompraService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    CondicionCompraService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    CondicionCompraService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    CondicionCompraService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], CondicionCompraService);
    return CondicionCompraService;
}());
exports.CondicionCompraService = CondicionCompraService;
//# sourceMappingURL=condicion-compra.service.js.map