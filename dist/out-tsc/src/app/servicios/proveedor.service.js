...
var ProveedorService = /** @class */ (function () {
    //Constructor
    function ProveedorService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    ProveedorService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ProveedorService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por alias
    ProveedorService.prototype.listarPorAlias = function (alias) {
    ...
    //Agrega un registro
    ProveedorService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ProveedorService.prototype.actualizar = function (elemento) {
