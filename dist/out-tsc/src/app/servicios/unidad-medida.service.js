...
var UnidadMedidaService = /** @class */ (function () {
    //Constructor
    function UnidadMedidaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/unidadmedida";
        //Define la url base
        this.url = null;
    ...
    UnidadMedidaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    UnidadMedidaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    UnidadMedidaService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    UnidadMedidaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    UnidadMedidaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    UnidadMedidaService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    UnidadMedidaService = __decorate([
        core_1.Injectable(),
...
//# sourceMappingURL=unidad-medida.service.js.map