...
var OrdenVentaEscalaService = /** @class */ (function () {
    //Constructor
    function OrdenVentaEscalaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/ordenventaescala";
        //Define la url base
        this.url = null;
    ...
    OrdenVentaEscalaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene el precio flete por id
    // El valor puede ser: bultos, kg, m3
    OrdenVentaEscalaService.prototype.obtenerPrecioFlete = function (id, valor) {
        return this.http.get(this.url + '/obtenerPrecioFlete/' + id + '/' + valor, this.options);
    };
    //Obtiene la lista de registros
    OrdenVentaEscalaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene una lista con escalas tarifas asignadas
    OrdenVentaEscalaService.prototype.listarConEscalaTarifa = function () {
        return this.http.get(this.url + '/listarConEscalaTarifa', this.options);
    };
    //Obtiene una lista por id de Orden Venta
    OrdenVentaEscalaService.prototype.listarPorOrdenVenta = function (id) {
        return this.http.get(this.url + '/listarPorOrdenVenta/' + id, this.options);
    };
    //Agrega un registro
    OrdenVentaEscalaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    OrdenVentaEscalaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    OrdenVentaEscalaService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    OrdenVentaEscalaService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], OrdenVentaEscalaService);
    return OrdenVentaEscalaService;
}());
exports.OrdenVentaEscalaService = OrdenVentaEscalaService;
//# sourceMappingURL=orden-venta-escala.service.js.map