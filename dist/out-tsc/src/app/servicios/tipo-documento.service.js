...
var TipoDocumentoService = /** @class */ (function () {
    //Constructor
    function TipoDocumentoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/tipodocumento";
        //Define la url base
        this.url = null;
    ...
    TipoDocumentoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    TipoDocumentoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    TipoDocumentoService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    TipoDocumentoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    TipoDocumentoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    TipoDocumentoService.prototype.eliminar = function (id) {
