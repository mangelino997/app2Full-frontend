...
var TipoComprobanteService = /** @class */ (function () {
    //Constructor
    function TipoComprobanteService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/tipocomprobante";
        //Define la url base
        this.url = null;
    ...
    TipoComprobanteService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene registros por id
    TipoComprobanteService.prototype.obtenerPorId = function (id) {
        return this.http.get(this.url + '/obtenerPorId/' + id, this.options);
    };
    //Obtiene la lista de registros
    TipoComprobanteService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    TipoComprobanteService.prototype.listarPorNombre = function (nombre) {
    ...
    TipoComprobanteService.prototype.listarPorEstaActivoIngresoCargaTrue = function () {
        return this.http.get(this.url + '/listarPorEstaActivoIngresoCargaTrue', this.options);
    };
    //Agrega un registro
    TipoComprobanteService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    TipoComprobanteService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    TipoComprobanteService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    TipoComprobanteService = __decorate([
        core_1.Injectable(),
