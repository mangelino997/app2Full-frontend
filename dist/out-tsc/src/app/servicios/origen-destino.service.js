...
var OrigenDestinoService = /** @class */ (function () {
    //Constructor
    function OrigenDestinoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/origendestino";
        //Define la url base
        this.url = null;
    ...
    OrigenDestinoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    OrigenDestinoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    OrigenDestinoService.prototype.listarPorNombre = function (nombre) {
    ...
    OrigenDestinoService.prototype.listarPorProvincia = function (idProvincia) {
        return this.http.get(this.url + '/listarPorProvincia/' + idProvincia, this.options);
    };
    //Agrega un registro
    OrigenDestinoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    OrigenDestinoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    OrigenDestinoService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    OrigenDestinoService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], OrigenDestinoService);
    return OrigenDestinoService;
}());
exports.OrigenDestinoService = OrigenDestinoService;
//# sourceMappingURL=origen-destino.service.js.map