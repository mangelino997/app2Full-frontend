...
var LocalidadService = /** @class */ (function () {
    //Constructor
    function LocalidadService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    LocalidadService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    LocalidadService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    LocalidadService.prototype.listarPorNombre = function (nombre) {
    ...
    LocalidadService.prototype.listarPorProvincia = function (idProvincia) {
        return this.http.get(this.url + '/listarPorProvincia/' + idProvincia, this.options);
    };
    //Agrega un registro
    LocalidadService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    LocalidadService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    LocalidadService.prototype.eliminar = function (id) {
