...
var VehiculoService = /** @class */ (function () {
    //Constructor
    function VehiculoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    VehiculoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    VehiculoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por alias
    VehiculoService.prototype.listarPorAlias = function (alias) {
    ...
    VehiculoService.prototype.listarPorAliasFiltroRemolque = function (alias) {
    ...
    //Agrega un registro
    VehiculoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    VehiculoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    VehiculoService.prototype.eliminar = function (id) {
