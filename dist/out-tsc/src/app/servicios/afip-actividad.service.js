...
var AfipActividadService = /** @class */ (function () {
    //Constructor
    function AfipActividadService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/afipactividad";
        //Define la url base
        this.url = null;
    ...
    AfipActividadService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    AfipActividadService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    AfipActividadService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    AfipActividadService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    AfipActividadService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    AfipActividadService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    AfipActividadService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], AfipActividadService);
    return AfipActividadService;
}());
exports.AfipActividadService = AfipActividadService;
//# sourceMappingURL=afip-actividad.service.js.map