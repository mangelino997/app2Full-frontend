...
var GrupoCuentaContableService = /** @class */ (function () {
    //Constructor
    function GrupoCuentaContableService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/grupocuentacontable";
        //Define la url base
        this.url = null;
    ...
    GrupoCuentaContableService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    GrupoCuentaContableService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    GrupoCuentaContableService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    GrupoCuentaContableService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    GrupoCuentaContableService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    GrupoCuentaContableService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    GrupoCuentaContableService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], GrupoCuentaContableService);
    return GrupoCuentaContableService;
}());
exports.GrupoCuentaContableService = GrupoCuentaContableService;
//# sourceMappingURL=grupo-cuenta-contable.service.js.map