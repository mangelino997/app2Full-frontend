...
var AreaService = /** @class */ (function () {
    //Constructor
    function AreaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    AreaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    AreaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    AreaService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    AreaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    AreaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    AreaService.prototype.eliminar = function (id) {
