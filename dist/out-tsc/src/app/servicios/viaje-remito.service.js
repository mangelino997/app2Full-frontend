...
var ViajeRemitoService = /** @class */ (function () {
    //Constructor
    function ViajeRemitoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/viajeremito";
        //Define la url base
        this.url = null;
    ...
    ViajeRemitoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ViajeRemitoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene la lista de Remito por idTramo y Item
    ViajeRemitoService.prototype.listarRemitos = function (idTramo, idItem) {
        return this.http.get(this.url + '/listarRemitos/' + idTramo + '/' + idItem, this.options);
    };
    //Obtiene una lista por alias
    ViajeRemitoService.prototype.listarPorAlias = function (alias) {
    ...
    ViajeRemitoService.prototype.listarPorNumero = function (numero) {
        return this.http.get(this.url + '/listarPorNumero/' + numero, this.options);
    };
    //Obtiene una lista de remitos pendientes por sucursal
    ViajeRemitoService.prototype.listarPendientesPorSucursal = function (idSucursal) {
    ...
    ViajeRemitoService.prototype.listarPendientesPorFiltro = function (idSucursal, idSucursalDestino, numeroCamion) {
    ...
    ViajeRemitoService.prototype.listarAsignadosPorFiltro = function (idSucursal, idSucursalDestino, numeroCamion, idViajePropioTramo) {
        return this.http.get(this.url + '/listarPendientesPorFiltro/' + idSucursal
            + '/' + idSucursalDestino + '/' + numeroCamion + '/' + idViajePropioTramo, this.options);
    };
    //Asigna remitos
    ViajeRemitoService.prototype.asignar = function (elemento) {
        return this.http.put(this.url + '/asignar', elemento, this.options);
    };
    //Quita remitos
    ViajeRemitoService.prototype.quitar = function (elemento) {
        return this.http.put(this.url + '/quitar', elemento, this.options);
    };
    //Agrega un registro
    ViajeRemitoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ViajeRemitoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ViajeRemitoService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    ViajeRemitoService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], ViajeRemitoService);
    return ViajeRemitoService;
}());
exports.ViajeRemitoService = ViajeRemitoService;
//# sourceMappingURL=viaje-remito.service.js.map