...
var EscalaTarifaService = /** @class */ (function () {
    //Constructor
    function EscalaTarifaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/escalatarifa";
        //Define la url base
        this.url = null;
    ...
    EscalaTarifaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    EscalaTarifaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Agrega un registro
    EscalaTarifaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    EscalaTarifaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    EscalaTarifaService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    EscalaTarifaService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], EscalaTarifaService);
    return EscalaTarifaService;
}());
exports.EscalaTarifaService = EscalaTarifaService;
//# sourceMappingURL=escala-tarifa.service.js.map