...
var AfipConceptoService = /** @class */ (function () {
    //Constructor
    function AfipConceptoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/afipconcepto";
        //Define la url base
        this.url = null;
    ...
    AfipConceptoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    AfipConceptoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    AfipConceptoService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    AfipConceptoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    AfipConceptoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    AfipConceptoService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    AfipConceptoService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], AfipConceptoService);
    return AfipConceptoService;
}());
exports.AfipConceptoService = AfipConceptoService;
//# sourceMappingURL=afip-concepto.service.js.map