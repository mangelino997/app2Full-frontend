...
var EmpresaService = /** @class */ (function () {
    //Constructor
    function EmpresaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    EmpresaService.prototype.obtenerSiguienteId = function () {
    ...
    EmpresaService.prototype.listarPorRazonSocial = function (razonSocial) {
        return this.http.get(this.url + '/listarPorRazonSocial/' + razonSocial, this.options).map(function (res) {
    ...
    //Agrega un registro
    EmpresaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    EmpresaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    EmpresaService.prototype.eliminar = function (id) {
