...
var TipoProveedorService = /** @class */ (function () {
    //Constructor
    function TipoProveedorService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/tipoproveedor";
        //Define la url base
        this.url = null;
    ...
    TipoProveedorService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    TipoProveedorService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    TipoProveedorService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    TipoProveedorService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    TipoProveedorService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    TipoProveedorService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    TipoProveedorService = __decorate([
        core_1.Injectable(),
...
exports.TipoProveedorService = TipoProveedorService;
//# sourceMappingURL=tipo-proveedor.service.js.map