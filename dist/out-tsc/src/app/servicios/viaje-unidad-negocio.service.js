...
var ViajeUnidadNegocioService = /** @class */ (function () {
    //Constructor
    function ViajeUnidadNegocioService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/viajeunidadnegocio";
        //Define la url base
        this.url = null;
    ...
    ViajeUnidadNegocioService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ViajeUnidadNegocioService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    ViajeUnidadNegocioService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    ViajeUnidadNegocioService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ViajeUnidadNegocioService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ViajeUnidadNegocioService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    ViajeUnidadNegocioService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], ViajeUnidadNegocioService);
    return ViajeUnidadNegocioService;
}());
exports.ViajeUnidadNegocioService = ViajeUnidadNegocioService;
//# sourceMappingURL=viaje-unidad-negocio.service.js.map