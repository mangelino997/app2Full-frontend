...
var RolSubopcionService = /** @class */ (function () {
    //Constructor
    function RolSubopcionService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/rolsubopcion";
        //Define la url base
        this.url = null;
    ...
    RolSubopcionService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    RolSubopcionService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene una lista por rol y subopcion
    RolSubopcionService.prototype.listarPorRolYSubopcion = function (idRol, idSubopcion) {
        return this.http.get(this.url + '/listarPorRolYSubmodulo/' + idRol + '/' + idSubopcion, this.options);
    };
    //Agrega un registro
    RolSubopcionService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    RolSubopcionService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    RolSubopcionService.prototype.eliminar = function (id) {
    ...
    */
    RolSubopcionService.prototype.reestablecerTablaDesdeCero = function () {
        return this.http.get(this.url + '/reestablecerTablaDesdeCero', this.options);
    };
    RolSubopcionService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], RolSubopcionService);
    return RolSubopcionService;
}());
exports.RolSubopcionService = RolSubopcionService;
//# sourceMappingURL=rol-subopcion.service.js.map