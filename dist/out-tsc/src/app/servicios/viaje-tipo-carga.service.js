...
var ViajeTipoCargaService = /** @class */ (function () {
    //Constructor
    function ViajeTipoCargaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/viajetipocarga";
        //Define la url base
        this.url = null;
    ...
    ViajeTipoCargaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ViajeTipoCargaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    ViajeTipoCargaService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    ViajeTipoCargaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ViajeTipoCargaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ViajeTipoCargaService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    ViajeTipoCargaService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], ViajeTipoCargaService);
    return ViajeTipoCargaService;
}());
exports.ViajeTipoCargaService = ViajeTipoCargaService;
//# sourceMappingURL=viaje-tipo-carga.service.js.map