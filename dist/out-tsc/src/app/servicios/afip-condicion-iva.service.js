...
var AfipCondicionIvaService = /** @class */ (function () {
    //Constructor
    function AfipCondicionIvaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/afipcondicioniva";
        //Define la url base
        this.url = null;
    ...
    AfipCondicionIvaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    AfipCondicionIvaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    AfipCondicionIvaService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    AfipCondicionIvaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    AfipCondicionIvaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    AfipCondicionIvaService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    AfipCondicionIvaService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], AfipCondicionIvaService);
    return AfipCondicionIvaService;
}());
exports.AfipCondicionIvaService = AfipCondicionIvaService;
//# sourceMappingURL=afip-condicion-iva.service.js.map