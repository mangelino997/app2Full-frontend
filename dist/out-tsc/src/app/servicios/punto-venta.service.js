...
var PuntoVentaService = /** @class */ (function () {
    //Constructor
    function PuntoVentaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/puntoventa";
        //Define la url base
        this.url = null;
    ...
    PuntoVentaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene el Numero por PuntoVenta y codigoAfip
    PuntoVentaService.prototype.obtenerNumero = function (punto, codigo, sucursal, empresa) {
        return this.http.get(this.url + '/obtenerNumero/' + punto + '/' + codigo + '/' + sucursal + '/' + empresa, this.options);
    };
    //Obtiene la lista de registros
    PuntoVentaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene una lista por sucursal
    PuntoVentaService.prototype.listarPorSucursal = function (id) {
        return this.http.get(this.url + '/listarPorSucursal/' + id, this.options);
    };
    //Obtiene una lista por empresa y sucursal
    PuntoVentaService.prototype.listarPorEmpresaYSucursal = function (idEmpresa, idSucursal) {
        return this.http.get(this.url + '/listarPorEmpresaYSucursal/' + idEmpresa + '/' + idSucursal, this.options);
    };
    //Agrega un registro
    PuntoVentaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    PuntoVentaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    PuntoVentaService.prototype.eliminar = function (id) {
...
exports.PuntoVentaService = PuntoVentaService;
//# sourceMappingURL=punto-venta.service.js.map