...
var CompaniaSeguroService = /** @class */ (function () {
    //Constructor
    function CompaniaSeguroService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/companiaseguro";
        //Define la url base
        this.url = null;
    ...
    CompaniaSeguroService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    CompaniaSeguroService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    CompaniaSeguroService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    CompaniaSeguroService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    CompaniaSeguroService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    CompaniaSeguroService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    CompaniaSeguroService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], CompaniaSeguroService);
    return CompaniaSeguroService;
}());
exports.CompaniaSeguroService = CompaniaSeguroService;
//# sourceMappingURL=compania-seguro.service.js.map