...
var ContactoBancoService = /** @class */ (function () {
    //Constructor
    function ContactoBancoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/contactobanco";
        //Define la url base
        this.url = null;
    ...
    ContactoBancoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ContactoBancoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    ContactoBancoService.prototype.listarPorNombre = function (nombre) {
    ...
    ContactoBancoService.prototype.listarPorSucursalBanco = function (idSucursalBanco) {
        return this.http.get(this.url + '/listarPorSucursalBanco/' + idSucursalBanco, this.options);
    };
    //Agrega un registro
    ContactoBancoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ContactoBancoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ContactoBancoService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    ContactoBancoService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], ContactoBancoService);
    return ContactoBancoService;
}());
exports.ContactoBancoService = ContactoBancoService;
//# sourceMappingURL=contacto-banco.service.js.map