...
var ResumenClienteService = /** @class */ (function () {
    //Constructor
    function ResumenClienteService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/resumencliente";
        //Define la url base
        this.url = null;
    ...
    ResumenClienteService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ResumenClienteService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    ResumenClienteService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    ResumenClienteService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ResumenClienteService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ResumenClienteService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    ResumenClienteService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], ResumenClienteService);
    return ResumenClienteService;
}());
exports.ResumenClienteService = ResumenClienteService;
//# sourceMappingURL=resumen-cliente.service.js.map