...
var ClienteService = /** @class */ (function () {
    //Constructor
    function ClienteService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    ClienteService.prototype.obtenerSiguienteId = function () {
    ...
    ClienteService.prototype.listarPorAlias = function (alias) {
    ...
    ClienteService.prototype.agregarClienteEventual = function (elemento) {
        return this.http.post(this.url + '/agregarClienteEventual', elemento, this.options);
    };
    //Agrega un registro
    ClienteService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ClienteService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ClienteService.prototype.eliminar = function (id) {
