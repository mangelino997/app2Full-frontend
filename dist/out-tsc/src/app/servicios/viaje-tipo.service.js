...
var ViajeTipoService = /** @class */ (function () {
    //Constructor
    function ViajeTipoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    ViajeTipoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ViajeTipoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    ViajeTipoService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    ViajeTipoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ViajeTipoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ViajeTipoService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    ViajeTipoService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], ViajeTipoService);
    return ViajeTipoService;
}());
exports.ViajeTipoService = ViajeTipoService;
//# sourceMappingURL=viaje-tipo.service.js.map