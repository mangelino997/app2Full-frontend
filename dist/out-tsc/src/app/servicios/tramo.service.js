...
var TramoService = /** @class */ (function () {
    //Constructor
    function TramoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    TramoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    TramoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por origen
    TramoService.prototype.listarPorOrigen = function (origen) {
        return this.http.get(this.url + '/listarPorOrigen/' + origen, this.options).map(function (res) {
    ...
    //Agrega un registro
    TramoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    TramoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    TramoService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    TramoService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], TramoService);
    return TramoService;
}());
exports.TramoService = TramoService;
//# sourceMappingURL=tramo.service.js.map