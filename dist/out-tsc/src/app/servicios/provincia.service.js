...
var ProvinciaService = /** @class */ (function () {
    //Constructor
    function ProvinciaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    ProvinciaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ProvinciaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    ProvinciaService.prototype.listarPorNombre = function (nombre) {
    ...
    ProvinciaService.prototype.listarPorPais = function (idPais) {
        return this.http.get(this.url + '/listarPorPais/' + idPais, this.options);
    };
    //Agrega un registro
    ProvinciaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ProvinciaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ProvinciaService.prototype.eliminar = function (id) {
