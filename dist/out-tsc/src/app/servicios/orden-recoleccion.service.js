...
var OrdenRecoleccionService = /** @class */ (function () {
    //Constructor
    function OrdenRecoleccionService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/ordenrecoleccion";
        //Define la url base
        this.url = null;
    ...
    OrdenRecoleccionService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    OrdenRecoleccionService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene la lista de registros
    OrdenRecoleccionService.prototype.listarPorAlias = function (alias) {
        return this.http.get(this.url + '/listarPorAlias/' + alias, this.options);
    };
    //Obtiene el listado por id
    OrdenRecoleccionService.prototype.obtenerPorId = function (id) {
        return this.http.get(this.url + '/obtenerPorId/' + id, this.options);
    };
    //Agrega un registro
    OrdenRecoleccionService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    OrdenRecoleccionService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    OrdenRecoleccionService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    OrdenRecoleccionService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], OrdenRecoleccionService);
    return OrdenRecoleccionService;
}());
exports.OrdenRecoleccionService = OrdenRecoleccionService;
//# sourceMappingURL=orden-recoleccion.service.js.map