...
var TipoVehiculoService = /** @class */ (function () {
    //Constructor
    function TipoVehiculoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    TipoVehiculoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    TipoVehiculoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    TipoVehiculoService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    TipoVehiculoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    TipoVehiculoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    TipoVehiculoService.prototype.eliminar = function (id) {
...
exports.TipoVehiculoService = TipoVehiculoService;
