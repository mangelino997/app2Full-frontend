...
var TipoCuentaBancariaService = /** @class */ (function () {
    //Constructor
    function TipoCuentaBancariaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/tipocuentabancaria";
        //Define la url base
        this.url = null;
    ...
    TipoCuentaBancariaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    TipoCuentaBancariaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    TipoCuentaBancariaService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    TipoCuentaBancariaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    TipoCuentaBancariaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    TipoCuentaBancariaService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    TipoCuentaBancariaService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], TipoCuentaBancariaService);
    return TipoCuentaBancariaService;
}());
exports.TipoCuentaBancariaService = TipoCuentaBancariaService;
//# sourceMappingURL=tipo-cuenta-bancaria.service.js.map