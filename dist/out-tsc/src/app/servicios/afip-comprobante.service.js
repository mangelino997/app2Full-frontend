...
var AfipComprobanteService = /** @class */ (function () {
    //Constructor
    function AfipComprobanteService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/afipcomprobante";
        //Define la url base
        this.url = null;
    ...
    AfipComprobanteService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene letra por id de quien paga
    AfipComprobanteService.prototype.obtenerLetra = function (id) {
        return this.http.get(this.url + '/obtenerLetra/' + id, this.options);
    };
    //Obtiene CodigoAfip por id de tipoComprobante y letra
    AfipComprobanteService.prototype.obtenerCodigoAfip = function (idTipoComprobante, letra) {
        return this.http.get(this.url + '/obtenerCodigoAfip/' + idTipoComprobante + '/' + letra, this.options);
    };
    //Obtiene la lista de registros
    AfipComprobanteService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    AfipComprobanteService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    AfipComprobanteService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    AfipComprobanteService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    AfipComprobanteService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    AfipComprobanteService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], AfipComprobanteService);
    return AfipComprobanteService;
}());
exports.AfipComprobanteService = AfipComprobanteService;
//# sourceMappingURL=afip-comprobante.service.js.map