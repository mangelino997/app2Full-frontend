...
var AfipSituacionService = /** @class */ (function () {
    //Constructor
    function AfipSituacionService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/afipsituacion";
        //Define la url base
        this.url = null;
    ...
    AfipSituacionService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    AfipSituacionService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    AfipSituacionService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    AfipSituacionService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    AfipSituacionService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    AfipSituacionService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    AfipSituacionService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], AfipSituacionService);
    return AfipSituacionService;
}());
exports.AfipSituacionService = AfipSituacionService;
//# sourceMappingURL=afip-situacion.service.js.map