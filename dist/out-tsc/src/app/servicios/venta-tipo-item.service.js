...
var VentaTipoItemService = /** @class */ (function () {
    //Constructor
    function VentaTipoItemService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/ventatipoitem";
        //Define la url base
        this.url = null;
    ...
    VentaTipoItemService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    VentaTipoItemService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene la lista de registros-Items
    VentaTipoItemService.prototype.listarItems = function () {
        return this.http.get(this.url + '/listarItems', this.options);
    };
    //Obtiene un listado por nombre
    VentaTipoItemService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    VentaTipoItemService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    VentaTipoItemService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    VentaTipoItemService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    VentaTipoItemService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], VentaTipoItemService);
    return VentaTipoItemService;
}());
exports.VentaTipoItemService = VentaTipoItemService;
//# sourceMappingURL=venta-tipo-item.service.js.map