...
var InsumoProductoService = /** @class */ (function () {
    //Constructor
    function InsumoProductoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/insumoproducto";
        //Define la url base
        this.url = null;
    ...
    InsumoProductoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    InsumoProductoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    InsumoProductoService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    InsumoProductoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    InsumoProductoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    InsumoProductoService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    InsumoProductoService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], InsumoProductoService);
    return InsumoProductoService;
}());
exports.InsumoProductoService = InsumoProductoService;
//# sourceMappingURL=insumo-producto.service.js.map