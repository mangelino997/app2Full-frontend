...
var MarcaVehiculoService = /** @class */ (function () {
    //Constructor
    function MarcaVehiculoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/marcavehiculo";
        //Define la url base
        this.url = null;
    ...
    MarcaVehiculoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    MarcaVehiculoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    MarcaVehiculoService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    MarcaVehiculoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    MarcaVehiculoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    MarcaVehiculoService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    MarcaVehiculoService = __decorate([
        core_1.Injectable(),
...
exports.MarcaVehiculoService = MarcaVehiculoService;
//# sourceMappingURL=marca-vehiculo.service.js.map