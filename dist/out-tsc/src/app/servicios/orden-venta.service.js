...
var OrdenVentaService = /** @class */ (function () {
    //Constructor
    function OrdenVentaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/ordenventa";
        //Define la url base
        this.url = null;
    ...
    OrdenVentaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    OrdenVentaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    OrdenVentaService.prototype.listarPorNombre = function (nombre) {
    ...
    OrdenVentaService.prototype.listarPorEmpresa = function (id) {
        return this.http.get(this.url + '/listarPorEmpresa/' + id, this.options);
    };
    //Obtiene el listado por Cliente
    OrdenVentaService.prototype.listarPorCliente = function (id) {
        return this.http.get(this.url + '/listarPorCliente/' + id, this.options);
    };
    //Agrega un registro
    OrdenVentaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    OrdenVentaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    OrdenVentaService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    OrdenVentaService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], OrdenVentaService);
    return OrdenVentaService;
}());
exports.OrdenVentaService = OrdenVentaService;
//# sourceMappingURL=orden-venta.service.js.map