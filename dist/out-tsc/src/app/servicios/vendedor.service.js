...
var VendedorService = /** @class */ (function () {
    //Constructor
    function VendedorService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    VendedorService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    VendedorService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    VendedorService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    VendedorService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    VendedorService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    VendedorService.prototype.eliminar = function (id) {
