...
var AfipCondicionService = /** @class */ (function () {
    //Constructor
    function AfipCondicionService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/afipcondicion";
        //Define la url base
        this.url = null;
    ...
    AfipCondicionService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    AfipCondicionService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    AfipCondicionService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    AfipCondicionService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    AfipCondicionService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    AfipCondicionService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    AfipCondicionService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], AfipCondicionService);
    return AfipCondicionService;
}());
exports.AfipCondicionService = AfipCondicionService;
//# sourceMappingURL=afip-condicion.service.js.map