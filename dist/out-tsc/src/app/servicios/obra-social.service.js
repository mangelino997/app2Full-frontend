...
var ObraSocialService = /** @class */ (function () {
    //Constructor
    function ObraSocialService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/obrasocial";
        //Define la url base
        this.url = null;
    ...
    ObraSocialService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ObraSocialService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    ObraSocialService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    ObraSocialService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ObraSocialService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ObraSocialService.prototype.eliminar = function (id) {
...
exports.ObraSocialService = ObraSocialService;
//# sourceMappingURL=obra-social.service.js.map