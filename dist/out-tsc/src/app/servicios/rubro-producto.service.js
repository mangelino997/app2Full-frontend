...
var RubroProductoService = /** @class */ (function () {
    //Constructor
    function RubroProductoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/rubroproducto";
        //Define la url base
        this.url = null;
    ...
    RubroProductoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    RubroProductoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    RubroProductoService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    RubroProductoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    RubroProductoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    RubroProductoService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    RubroProductoService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], RubroProductoService);
    return RubroProductoService;
}());
exports.RubroProductoService = RubroProductoService;
//# sourceMappingURL=rubro-producto.service.js.map