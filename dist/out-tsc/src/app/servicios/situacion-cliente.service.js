...
var SituacionClienteService = /** @class */ (function () {
    //Constructor
    function SituacionClienteService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/situacioncliente";
        //Define la url base
        this.url = null;
    ...
    SituacionClienteService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    SituacionClienteService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    SituacionClienteService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    SituacionClienteService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    SituacionClienteService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    SituacionClienteService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    SituacionClienteService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], SituacionClienteService);
    return SituacionClienteService;
}());
exports.SituacionClienteService = SituacionClienteService;
//# sourceMappingURL=situacion-cliente.service.js.map