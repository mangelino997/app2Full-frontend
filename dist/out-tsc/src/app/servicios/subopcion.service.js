...
var SubopcionService = /** @class */ (function () {
    //Constructor
    function SubopcionService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    SubopcionService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    SubopcionService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    SubopcionService.prototype.listarPorNombre = function (nombre) {
    ...
    //Obtiene el listado de subopciones por submodulo
    SubopcionService.prototype.listarPorSubmodulo = function (idSubmodulo) {
        return this.http.get(this.url + '/listarPorSubmodulo/' + idSubmodulo, this.options);
    };
    //Agrega un registro
    SubopcionService.prototype.agregar = function (elemento) {
        return this.http.post(this.url + '/agregar', elemento, this.options);
    };
    //Actualiza un registro
    SubopcionService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    SubopcionService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    SubopcionService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], SubopcionService);
    return SubopcionService;
}());
exports.SubopcionService = SubopcionService;
//# sourceMappingURL=subopcion.service.js.map