...
var CategoriaService = /** @class */ (function () {
    //Constructor
    function CategoriaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    CategoriaService.prototype.obtenerSiguienteId = function () {
    ...
    CategoriaService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    CategoriaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    CategoriaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    CategoriaService.prototype.eliminar = function (id) {
