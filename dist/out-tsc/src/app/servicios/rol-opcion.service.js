...
var RolOpcionService = /** @class */ (function () {
    //Constructor
    function RolOpcionService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    RolOpcionService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por rol y subopcion
    RolOpcionService.prototype.listarPorRolSubopcion = function (idRol, idSubopcion) {
        return this.http.get(this.url + '/listarPorRolSubopcion/' + idRol + '/' + idSubopcion, this.options);
    };
    RolOpcionService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], RolOpcionService);
    return RolOpcionService;
}());
exports.RolOpcionService = RolOpcionService;
//# sourceMappingURL=rol-opcion.service.js.map