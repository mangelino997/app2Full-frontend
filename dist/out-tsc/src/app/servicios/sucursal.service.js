...
var SucursalService = /** @class */ (function () {
    //Constructor
    function SucursalService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    SucursalService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    SucursalService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    SucursalService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    SucursalService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    SucursalService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    SucursalService.prototype.eliminar = function (id) {
