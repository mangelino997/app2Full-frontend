...
var CondicionVentaService = /** @class */ (function () {
    //Constructor
    function CondicionVentaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/condicionventa";
        //Define la url base
        this.url = null;
    ...
    CondicionVentaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    CondicionVentaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    CondicionVentaService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    CondicionVentaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    CondicionVentaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    CondicionVentaService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    CondicionVentaService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], CondicionVentaService);
    return CondicionVentaService;
}());
exports.CondicionVentaService = CondicionVentaService;
//# sourceMappingURL=condicion-venta.service.js.map