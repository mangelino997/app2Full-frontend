...
var SeguridadSocialService = /** @class */ (function () {
    //Constructor
    function SeguridadSocialService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/seguridadsocial";
        //Define la url base
        this.url = null;
    ...
    SeguridadSocialService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    SeguridadSocialService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    SeguridadSocialService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    SeguridadSocialService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    SeguridadSocialService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    SeguridadSocialService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    SeguridadSocialService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], SeguridadSocialService);
    return SeguridadSocialService;
}());
exports.SeguridadSocialService = SeguridadSocialService;
//# sourceMappingURL=seguridad-social.service.js.map