...
var TipoTarifaService = /** @class */ (function () {
    //Constructor
    function TipoTarifaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/tipotarifa";
        //Define la url base
        this.url = null;
    ...
    TipoTarifaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    TipoTarifaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    TipoTarifaService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    TipoTarifaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    TipoTarifaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    TipoTarifaService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    TipoTarifaService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], TipoTarifaService);
    return TipoTarifaService;
}());
exports.TipoTarifaService = TipoTarifaService;
//# sourceMappingURL=tipo-tarifa.service.js.map