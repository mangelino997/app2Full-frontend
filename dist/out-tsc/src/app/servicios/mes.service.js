...
var MesService = /** @class */ (function () {
    //Constructor
    function MesService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    MesService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    MesService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene la lista de Años
    MesService.prototype.listarMeses = function () {
        return this.http.get(this.url + '/listarMeses', this.options);
    };
    //Obtiene un listado por nombre
    MesService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    MesService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    MesService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    MesService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    MesService = __decorate([
        core_1.Injectable(),
