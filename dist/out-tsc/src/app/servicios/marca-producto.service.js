...
var MarcaProductoService = /** @class */ (function () {
    //Constructor
    function MarcaProductoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/marcaproducto";
        //Define la url base
        this.url = null;
    ...
    MarcaProductoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    MarcaProductoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    MarcaProductoService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    MarcaProductoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    MarcaProductoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    MarcaProductoService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    MarcaProductoService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], MarcaProductoService);
    return MarcaProductoService;
}());
exports.MarcaProductoService = MarcaProductoService;
//# sourceMappingURL=marca-producto.service.js.map