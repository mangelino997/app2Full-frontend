...
var SubmoduloService = /** @class */ (function () {
    //Constructor
    function SubmoduloService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    SubmoduloService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    SubmoduloService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    SubmoduloService.prototype.listarPorNombre = function (nombre) {
    ...
    SubmoduloService.prototype.listarPorModulo = function (idModulo) {
        return this.http.get(this.url + '/listarPorModulo/' + idModulo, this.options);
    };
    //Agrega un registro
    SubmoduloService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    SubmoduloService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    SubmoduloService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    SubmoduloService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], SubmoduloService);
    return SubmoduloService;
}());
exports.SubmoduloService = SubmoduloService;
//# sourceMappingURL=submodulo.service.js.map