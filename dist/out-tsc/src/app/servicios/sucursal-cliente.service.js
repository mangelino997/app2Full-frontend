...
var SucursalClienteService = /** @class */ (function () {
    //Constructor
    function SucursalClienteService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/sucursalcliente";
        //Define la url base
        this.url = null;
    ...
    SucursalClienteService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    SucursalClienteService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    SucursalClienteService.prototype.listarPorNombre = function (nombre) {
    ...
    SucursalClienteService.prototype.listarPorCliente = function (id) {
        return this.http.get(this.url + '/listarPorCliente/' + id, this.options);
    };
    //Obtiene un listado por alias del cliente
    SucursalClienteService.prototype.listarPorAliasCliente = function (alias) {
        return this.http.get(this.url + '/listarPorAliasCliente/' + alias, this.options).map(function (res) {
            return res.json().map(function (data) {
                return data;
            });
        });
    ...
    //Agrega un registro
    SucursalClienteService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    SucursalClienteService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    SucursalClienteService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    SucursalClienteService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], SucursalClienteService);
    return SucursalClienteService;
}());
exports.SucursalClienteService = SucursalClienteService;
//# sourceMappingURL=sucursal-cliente.service.js.map