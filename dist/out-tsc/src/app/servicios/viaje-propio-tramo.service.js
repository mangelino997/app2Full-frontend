...
var ViajePropioTramoService = /** @class */ (function () {
    //Constructor
    function ViajePropioTramoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/viajepropiotramo";
        //Define la url base
        this.url = null;
    ...
    ViajePropioTramoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene los tramos por id de tipoItem (1=propio/2=tercero)
    ViajePropioTramoService.prototype.listarTramos = function (id) {
        return this.http.get(this.url + '/listarTramos/' + id, this.options);
    };
    //Obtiene la lista de registros
    ViajePropioTramoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Agrega un registro
    ViajePropioTramoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ViajePropioTramoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ViajePropioTramoService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    ViajePropioTramoService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], ViajePropioTramoService);
    return ViajePropioTramoService;
}());
exports.ViajePropioTramoService = ViajePropioTramoService;
//# sourceMappingURL=viaje-propio-tramo.service.js.map