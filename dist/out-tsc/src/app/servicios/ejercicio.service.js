...
var EjercicioService = /** @class */ (function () {
    //Constructor
    function EjercicioService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    EjercicioService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    EjercicioService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene la lista de Años
    EjercicioService.prototype.listarAnios = function () {
        return this.http.get(this.url + '/listarAnios', this.options);
    };
    //Obtiene un listado por nombre
    EjercicioService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    EjercicioService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    EjercicioService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    EjercicioService.prototype.eliminar = function (id) {
