...
var ContactoProveedorService = /** @class */ (function () {
    //Constructor
    function ContactoProveedorService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/contactoproveedor";
        //Define la url base
        this.url = null;
    ...
    ContactoProveedorService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ContactoProveedorService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    ContactoProveedorService.prototype.listarPorNombre = function (nombre) {
    ...
    ContactoProveedorService.prototype.listarPorProveedor = function (idProveedor) {
        return this.http.get(this.url + '/listarPorProveedor/' + idProveedor, this.options);
    };
    //Agrega un registro
    ContactoProveedorService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ContactoProveedorService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ContactoProveedorService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    ContactoProveedorService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], ContactoProveedorService);
    return ContactoProveedorService;
}());
exports.ContactoProveedorService = ContactoProveedorService;
//# sourceMappingURL=contacto-proveedor.service.js.map