...
var AfipSiniestradoService = /** @class */ (function () {
    //Constructor
    function AfipSiniestradoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/afipsiniestrado";
        //Define la url base
        this.url = null;
    ...
    AfipSiniestradoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    AfipSiniestradoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    AfipSiniestradoService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    AfipSiniestradoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    AfipSiniestradoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    AfipSiniestradoService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    AfipSiniestradoService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], AfipSiniestradoService);
    return AfipSiniestradoService;
}());
exports.AfipSiniestradoService = AfipSiniestradoService;
//# sourceMappingURL=afip-siniestrado.service.js.map