...
var UsuarioService = /** @class */ (function () {
    //Constructor
    function UsuarioService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    UsuarioService.prototype.obtenerSiguienteId = function () {
    ...
    UsuarioService.prototype.obtenerPorUsername = function (username) {
        return this.http.get(this.url + '/obtenerPorUsername/' + username, this.options);
    };
    //Obtiene un listado por nombre
    UsuarioService.prototype.listarPorNombre = function (nombre) {
    ...
    UsuarioService.prototype.listarPorRol = function (idRol) {
        return this.http.get(this.url + '/listarPorRol/' + idRol, this.options);
    };
    //Obtiene una lista de usuarios por Empresa
    UsuarioService.prototype.listarUsuariosPorEmpresa = function (empresa) {
        return this.http.get(this.url + '/listarUsuariosPorEmpresa/' + empresa, this.options);
    };
    //Agrega un registro
    UsuarioService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    UsuarioService.prototype.actualizar = function (elemento) {
