...
var ContactoClienteService = /** @class */ (function () {
    //Constructor
    function ContactoClienteService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/contactocliente";
        //Define la url base
        this.url = null;
    ...
    ContactoClienteService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ContactoClienteService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    ContactoClienteService.prototype.listarPorNombre = function (nombre) {
    ...
    ContactoClienteService.prototype.listarPorCliente = function (idCliente) {
        return this.http.get(this.url + '/listarPorCliente/' + idCliente, this.options);
    };
    //Agrega un registro
    ContactoClienteService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ContactoClienteService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ContactoClienteService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    ContactoClienteService = __decorate([
        core_1.Injectable(),
...
exports.ContactoClienteService = ContactoClienteService;
//# sourceMappingURL=contacto-cliente.service.js.map