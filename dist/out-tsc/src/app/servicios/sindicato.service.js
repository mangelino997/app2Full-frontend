...
var SindicatoService = /** @class */ (function () {
    //Constructor
    function SindicatoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    SindicatoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    SindicatoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    SindicatoService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    SindicatoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    SindicatoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    SindicatoService.prototype.eliminar = function (id) {
