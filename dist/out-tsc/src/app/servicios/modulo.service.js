...
var ModuloService = /** @class */ (function () {
    //Constructor
    function ModuloService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    ModuloService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ModuloService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    ModuloService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    ModuloService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ModuloService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ModuloService.prototype.eliminar = function (id) {
