...
var AgendaTelefonicaService = /** @class */ (function () {
    //Constructor
    function AgendaTelefonicaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/agendatelefonica";
        //Define la url base
        this.url = null;
    ...
    AgendaTelefonicaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    AgendaTelefonicaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    AgendaTelefonicaService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    AgendaTelefonicaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    AgendaTelefonicaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    AgendaTelefonicaService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    AgendaTelefonicaService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], AgendaTelefonicaService);
    return AgendaTelefonicaService;
}());
exports.AgendaTelefonicaService = AgendaTelefonicaService;
//# sourceMappingURL=agenda-telefonica.service.js.map