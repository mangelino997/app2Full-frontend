...
var BarrioService = /** @class */ (function () {
    //Constructor
    function BarrioService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    BarrioService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    BarrioService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    BarrioService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    BarrioService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    BarrioService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    BarrioService.prototype.eliminar = function (id) {
