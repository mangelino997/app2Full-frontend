...
var ChoferProveedorService = /** @class */ (function () {
    //Constructor
    function ChoferProveedorService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/choferproveedor";
        //Define la url base
        this.url = null;
    ...
    ChoferProveedorService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ChoferProveedorService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por alias
    ChoferProveedorService.prototype.listarPorAlias = function (alias) {
    ...
    ChoferProveedorService.prototype.listarPorProveedor = function (id) {
        return this.http.get(this.url + '/listarPorProveedor/' + id, this.options);
    };
    //Agrega un registro
    ChoferProveedorService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ChoferProveedorService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ChoferProveedorService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    ChoferProveedorService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], ChoferProveedorService);
    return ChoferProveedorService;
}());
exports.ChoferProveedorService = ChoferProveedorService;
//# sourceMappingURL=chofer-proveedor.service.js.map