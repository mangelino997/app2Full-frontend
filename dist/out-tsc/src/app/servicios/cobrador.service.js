...
var CobradorService = /** @class */ (function () {
    //Constructor
    function CobradorService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    CobradorService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    CobradorService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    CobradorService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    CobradorService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    CobradorService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    CobradorService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    CobradorService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], CobradorService);
    return CobradorService;
}());
exports.CobradorService = CobradorService;
//# sourceMappingURL=cobrador.service.js.map