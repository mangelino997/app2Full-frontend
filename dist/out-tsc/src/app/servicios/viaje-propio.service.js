...
var ViajePropioService = /** @class */ (function () {
    //Constructor
    function ViajePropioService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/viajepropio";
        //Define la url base
        this.url = null;
    ...
    ViajePropioService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene por id
    ViajePropioService.prototype.obtenerPorId = function (id) {
        return this.http.get(this.url + '/obtenerPorId/' + id, this.options);
    };
    //Obtiene una lista de registros por alias
    ViajePropioService.prototype.listarPorAlias = function (alias) {
    ...
    ViajePropioService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Agrega un registro
    ViajePropioService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ViajePropioService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ViajePropioService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    ViajePropioService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], ViajePropioService);
    return ViajePropioService;
}());
exports.ViajePropioService = ViajePropioService;
//# sourceMappingURL=viaje-propio.service.js.map