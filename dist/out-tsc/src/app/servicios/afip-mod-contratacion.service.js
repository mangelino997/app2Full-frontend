...
var AfipModContratacionService = /** @class */ (function () {
    //Constructor
    function AfipModContratacionService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/afipmodcontratacion";
        //Define la url base
        this.url = null;
    ...
    AfipModContratacionService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    AfipModContratacionService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    AfipModContratacionService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    AfipModContratacionService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    AfipModContratacionService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    AfipModContratacionService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    AfipModContratacionService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], AfipModContratacionService);
    return AfipModContratacionService;
}());
exports.AfipModContratacionService = AfipModContratacionService;
//# sourceMappingURL=afip-mod-contratacion.service.js.map