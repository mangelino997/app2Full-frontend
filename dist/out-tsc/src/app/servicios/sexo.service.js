...
var SexoService = /** @class */ (function () {
    //Constructor
    function SexoService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    SexoService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    SexoService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    SexoService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    SexoService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    SexoService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    SexoService.prototype.eliminar = function (id) {
