...
var RubroService = /** @class */ (function () {
    //Constructor
    function RubroService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    RubroService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    RubroService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    RubroService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    RubroService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    RubroService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    RubroService.prototype.eliminar = function (id) {
...
exports.RubroService = RubroService;
