...
var TipoCuentaContableService = /** @class */ (function () {
    //Constructor
    function TipoCuentaContableService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/tipocuentacontable";
        //Define la url base
        this.url = null;
    ...
    TipoCuentaContableService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    TipoCuentaContableService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    TipoCuentaContableService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    TipoCuentaContableService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    TipoCuentaContableService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    TipoCuentaContableService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    TipoCuentaContableService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], TipoCuentaContableService);
    return TipoCuentaContableService;
}());
exports.TipoCuentaContableService = TipoCuentaContableService;
//# sourceMappingURL=tipo-cuenta-contable.service.js.map