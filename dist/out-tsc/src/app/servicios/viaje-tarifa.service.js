...
var ViajeTarifaService = /** @class */ (function () {
    //Constructor
    function ViajeTarifaService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/viajetarifa";
        //Define la url base
        this.url = null;
    ...
    ViajeTarifaService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    ViajeTarifaService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    ViajeTarifaService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    ViajeTarifaService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    ViajeTarifaService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    ViajeTarifaService.prototype.eliminar = function (id) {
        return this.http.delete(this.url + '/' + id, this.options);
    };
    ViajeTarifaService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, app_service_1.AppService, ng2_stompjs_1.StompService])
    ], ViajeTarifaService);
    return ViajeTarifaService;
}());
exports.ViajeTarifaService = ViajeTarifaService;
//# sourceMappingURL=viaje-tarifa.service.js.map