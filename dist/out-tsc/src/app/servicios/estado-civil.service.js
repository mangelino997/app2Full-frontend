...
var EstadoCivilService = /** @class */ (function () {
    //Constructor
    function EstadoCivilService(http, appService, stompService) {
        var _this = this;
        this.http = http;
        this.appService = appService;
        this.stompService = stompService;
        //Define la ruta al servicio web
        this.ruta = "/estadocivil";
        //Define la url base
        this.url = null;
    ...
    EstadoCivilService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    EstadoCivilService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    EstadoCivilService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    EstadoCivilService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    EstadoCivilService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    EstadoCivilService.prototype.eliminar = function (id) {
