...
var RolService = /** @class */ (function () {
    //Constructor
    function RolService(http, appService, stompService) {
        var _this = this;
        this.http = http;
    ...
    RolService.prototype.obtenerSiguienteId = function () {
        return this.http.get(this.url + '/obtenerSiguienteId', this.options);
    };
    //Obtiene la lista de registros
    RolService.prototype.listar = function () {
        return this.http.get(this.url, this.options);
    };
    //Obtiene un listado por nombre
    RolService.prototype.listarPorNombre = function (nombre) {
    ...
    //Agrega un registro
    RolService.prototype.agregar = function (elemento) {
        return this.http.post(this.url, elemento, this.options);
    };
    //Actualiza un registro
    RolService.prototype.actualizar = function (elemento) {
        return this.http.put(this.url, elemento, this.options);
    };
    //Elimina un registro
    RolService.prototype.eliminar = function (id) {
