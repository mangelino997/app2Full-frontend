...
var PaisComponent = /** @class */ (function () {
    //Constructor
    function PaisComponent(servicio, subopcionPestaniaService, appComponent, toastr) {
        var _this = this;
    ...
    PaisComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    PaisComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    PaisComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    PaisComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    PaisComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Agrega un registro
    PaisComponent.prototype.agregar = function () {
        var _this = this;
    ...
    PaisComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    PaisComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece los campos formularios
    PaisComponent.prototype.reestablecerFormulario = function (id) {
        this.formulario.reset();
    ...
    PaisComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    ;
    //Muestra en la pestania buscar el elemento seleccionado de listar
    PaisComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.patchValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    PaisComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.patchValue(elemento);
    };
    //Formatea el valor del autocompletado
    PaisComponent.prototype.displayFn = function (elemento) {
    ...
    PaisComponent.prototype.manejarEvento = function (keycode) {
    ...
    PaisComponent = __decorate([
        ...
        __metadata("design:paramtypes", [pais_service_1.PaisService, subopcion_pestania_service_1.SubopcionPestaniaService,
