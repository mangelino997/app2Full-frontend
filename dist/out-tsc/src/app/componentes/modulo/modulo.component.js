...
var ModuloComponent = /** @class */ (function () {
    //Constructor
    function ModuloComponent(servicio, subopcionPestaniaService, appComponent, toastr) {
        var _this = this;
        ...
        //Autcompletado - Buscar por nombre
    ...
    ModuloComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    ModuloComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    ModuloComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    ModuloComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    //Agrega un registro
    ModuloComponent.prototype.agregar = function () {
        var _this = this;
    ...
    ModuloComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    ModuloComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece el formulario
    ModuloComponent.prototype.reestablecerFormulario = function (id) {
    ...
    ModuloComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    ;
    //Muestra en la pestania buscar el elemento seleccionado de listar
    ModuloComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    ModuloComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra el valor en los autocompletados
    ModuloComponent.prototype.displayFn = function (elemento) {
    ...
    ModuloComponent.prototype.manejarEvento = function (keycode) {
    ...
    ModuloComponent = __decorate([
        ...
        __metadata("design:paramtypes", [modulo_service_1.ModuloService, subopcion_pestania_service_1.SubopcionPestaniaService,
            app_component_1.AppComponent, ngx_toastr_1.ToastrService])
    ], ModuloComponent);
    return ModuloComponent;
}());
exports.ModuloComponent = ModuloComponent;
