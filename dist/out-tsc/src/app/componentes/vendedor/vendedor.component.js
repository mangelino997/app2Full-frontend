...
var VendedorComponent = /** @class */ (function () {
    //Constructor
    function VendedorComponent(servicio, subopcionPestaniaService, appComponent, toastr) {
        var _this = this;
    ...
    VendedorComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    VendedorComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    VendedorComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    VendedorComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    VendedorComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Agrega un registro
    VendedorComponent.prototype.agregar = function () {
        var _this = this;
    ...
    VendedorComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    VendedorComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece el formulario
    VendedorComponent.prototype.reestablecerFormulario = function (id) {
    ...
    VendedorComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    ;
    //Muestra en la pestania buscar el elemento seleccionado de listar
    VendedorComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    VendedorComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    VendedorComponent.prototype.compararFn = function (a, b) {
        if (a != null && b != null) {
            return a.id === b.id;
        }
    };
    //Maneja los evento al presionar una tacla (para pestanias y opciones)
    VendedorComponent.prototype.manejarEvento = function (keycode) {
    ...
    VendedorComponent = __decorate([
        ...
        __metadata("design:paramtypes", [vendedor_service_1.VendedorService, subopcion_pestania_service_1.SubopcionPestaniaService,
            app_component_1.AppComponent, ngx_toastr_1.ToastrService])
    ], VendedorComponent);
    return VendedorComponent;
}());
exports.VendedorComponent = VendedorComponent;
//# sourceMappingURL=vendedor.component.js.map