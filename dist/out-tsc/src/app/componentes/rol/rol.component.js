...
var RolComponent = /** @class */ (function () {
    //Constructor
    function RolComponent(servicio, subopcionPestaniaService, appComponent, toastr) {
        var _this = this;
    ...
    RolComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    RolComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    RolComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    RolComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    RolComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Agrega un registro
    RolComponent.prototype.agregar = function () {
        var _this = this;
    ...
    RolComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    RolComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece el formulario
    RolComponent.prototype.reestablecerFormulario = function (id) {
    ...
    RolComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    ;
    //Muestra en la pestania buscar el elemento seleccionado de listar
    RolComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    RolComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Define como se muestra los datos en el autcompletado
    RolComponent.prototype.displayFn = function (elemento) {
    ...
    RolComponent.prototype.manejarEvento = function (keycode) {
    ...
    RolComponent = __decorate([
        ...
        __metadata("design:paramtypes", [rol_service_1.RolService, subopcion_pestania_service_1.SubopcionPestaniaService,
