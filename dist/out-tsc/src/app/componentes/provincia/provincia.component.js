...
var ProvinciaComponent = /** @class */ (function () {
    //Constructor
    function ProvinciaComponent(servicio, subopcionPestaniaService, paisServicio, appComponent, toastr) {
        var _this = this;
    ...
    ProvinciaComponent.prototype.ngOnInit = function () {
        ...
        this.formulario = new forms_1.FormGroup({
            ...
            codigoIIBB: new forms_1.FormControl('', [forms_1.Validators.min(1), forms_1.Validators.maxLength(10)]),
            codigoAfip: new forms_1.FormControl('', [forms_1.Validators.min(1), forms_1.Validators.maxLength(3)]),
            pais: new forms_1.FormControl('', forms_1.Validators.required)
        });
        //Establece los valores de la primera pestania activa
        this.seleccionarPestania(1, 'Agregar', 0);
        //Autocompletado Pais - Buscar por nombre
        this.formulario.get('pais').valueChanges.subscribe(function (data) {
            if (typeof data == 'string') {
                _this.paisServicio.listarPorNombre(data).subscribe(function (res) {
                    _this.resultadosPaises = res;
                });
            }
        });
    ...
    ProvinciaComponent.prototype.vaciarListas = function () {
        this.resultados = [];
        this.resultadosPaises = [];
    };
    //Funcion para establecer los valores de las pestañas
    ProvinciaComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    ProvinciaComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    ProvinciaComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    ProvinciaComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    ProvinciaComponent.prototype.listar = function () {
        var _this = this;
    ...
    ProvinciaComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    ProvinciaComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece el formulario
    ProvinciaComponent.prototype.reestablecerFormulario = function (id) {
    ...
    ProvinciaComponent.prototype.listarPorPais = function (pais) {
        var _this = this;
        this.servicio.listarPorPais(pais.id).subscribe(function (res) {
            _this.listaCompleta = res.json();
        });
    };
    //Manejo de colores de campos y labels
    ProvinciaComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    //Muestra en la pestania buscar el elemento seleccionado de listar
    ProvinciaComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    ProvinciaComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Formatea el valor del autocompletado
    ProvinciaComponent.prototype.displayFn = function (elemento) {
    ...
    ProvinciaComponent.prototype.displayFa = function (elemento) {
        if (elemento != undefined) {
    ...
    ProvinciaComponent.prototype.manejarEvento = function (keycode) {
    ...
    ProvinciaComponent = __decorate([
        ...
        __metadata("design:paramtypes", [provincia_service_1.ProvinciaService, subopcion_pestania_service_1.SubopcionPestaniaService,
            pais_service_1.PaisService, app_component_1.AppComponent, ngx_toastr_1.ToastrService])
    ], ProvinciaComponent);
