...
var SindicatoComponent = /** @class */ (function () {
    //Constructor
    function SindicatoComponent(servicio, subopcionPestaniaService, appComponent, toastr) {
        var _this = this;
    ...
    SindicatoComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    SindicatoComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    SindicatoComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    SindicatoComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    SindicatoComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Agrega un registro
    SindicatoComponent.prototype.agregar = function () {
        var _this = this;
    ...
    SindicatoComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    SindicatoComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece el formulario
    SindicatoComponent.prototype.reestablecerFormulario = function (id) {
    ...
    SindicatoComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    //Manejo de colores de campos y labels con patron erroneo
    SindicatoComponent.prototype.validarPatron = function (patron, campo) {
    ...
    SindicatoComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    SindicatoComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Define como se muestra los datos en el autcompletado
    SindicatoComponent.prototype.displayFn = function (elemento) {
    ...
    SindicatoComponent.prototype.manejarEvento = function (keycode) {
    ...
    SindicatoComponent = __decorate([
        ...
        __metadata("design:paramtypes", [sindicato_service_1.SindicatoService, subopcion_pestania_service_1.SubopcionPestaniaService,
            app_component_1.AppComponent, ngx_toastr_1.ToastrService])
    ], SindicatoComponent);
    return SindicatoComponent;
}());
exports.SindicatoComponent = SindicatoComponent;
//# sourceMappingURL=sindicato.component.js.map