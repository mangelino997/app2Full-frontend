...
var ZonaComponent = /** @class */ (function () {
    //Constructor
    function ZonaComponent(servicio, subopcionPestaniaService, appComponent, toastr) {
        var _this = this;
    ...
    ZonaComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    ZonaComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    ZonaComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    ZonaComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    ZonaComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Agrega un registro
    ZonaComponent.prototype.agregar = function () {
        var _this = this;
    ...
    ZonaComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    ZonaComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece el formulario
    ZonaComponent.prototype.reestablecerFormulario = function (id) {
    ...
    ZonaComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    ;
    //Muestra en la pestania buscar el elemento seleccionado de listar
    ZonaComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    ZonaComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Define como se muestra los datos en el autcompletado
    ZonaComponent.prototype.displayFn = function (elemento) {
    ...
    ZonaComponent.prototype.manejarEvento = function (keycode) {
    ...
    ZonaComponent = __decorate([
        ...
        __metadata("design:paramtypes", [zona_service_1.ZonaService, subopcion_pestania_service_1.SubopcionPestaniaService,
            app_component_1.AppComponent, ngx_toastr_1.ToastrService])
    ], ZonaComponent);
    return ZonaComponent;
}());
exports.ZonaComponent = ZonaComponent;
//# sourceMappingURL=zona.component.js.map