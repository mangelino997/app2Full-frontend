...
var RubroComponent = /** @class */ (function () {
    //Constructor
    function RubroComponent(servicio, subopcionPestaniaService, appComponent, toastr) {
        var _this = this;
    ...
    RubroComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    RubroComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    RubroComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    RubroComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    RubroComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Agrega un registro
    RubroComponent.prototype.agregar = function () {
        var _this = this;
    ...
    RubroComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    RubroComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece el formulario
    RubroComponent.prototype.reestablecerFormulario = function (id) {
    ...
    RubroComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    ;
    //Muestra en la pestania buscar el elemento seleccionado de listar
    RubroComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    RubroComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Define como se muestra los datos en el autcompletado
    RubroComponent.prototype.displayFn = function (elemento) {
    ...
    RubroComponent.prototype.manejarEvento = function (keycode) {
    ...
    RubroComponent = __decorate([
        ...
        __metadata("design:paramtypes", [rubro_service_1.RubroService, subopcion_pestania_service_1.SubopcionPestaniaService,
            app_component_1.AppComponent, ngx_toastr_1.ToastrService])
    ], RubroComponent);
    return RubroComponent;
}());
exports.RubroComponent = RubroComponent;
//# sourceMappingURL=rubro.component.js.map