...
var OrigenDestinoComponent = /** @class */ (function () {
    //Constructor
    function OrigenDestinoComponent(servicio, subopcionPestaniaService, provinciaServicio, appComponent, toastr) {
        var _this = this;
        ...
        this.pestanias = [];
        //Defiene el autocompletado para las busquedas
    ...
    OrigenDestinoComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.formulario.get('provincia').valueChanges.subscribe(function (data) {
            if (typeof data == 'string') {
                _this.provinciaServicio.listarPorNombre(data).subscribe(function (res) {
                    _this.resultadosProvincias = res;
                });
            }
        });
    };
    OrigenDestinoComponent.prototype.vaciarListas = function () {
        this.resultados = [];
        this.resultadosProvincias = [];
    };
    //Funcion para establecer los valores de las pestañas
    OrigenDestinoComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    OrigenDestinoComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    OrigenDestinoComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    OrigenDestinoComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    OrigenDestinoComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Agrega un registro
    OrigenDestinoComponent.prototype.agregar = function () {
        var _this = this;
    ...
    OrigenDestinoComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    OrigenDestinoComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece el formulario
    OrigenDestinoComponent.prototype.reestablecerFormulario = function (id) {
    ...
    OrigenDestinoComponent.prototype.listarPorProvincia = function (provincia) {
        var _this = this;
    ...
    OrigenDestinoComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    //Muestra en la pestania buscar el elemento seleccionado de listar
    OrigenDestinoComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    OrigenDestinoComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra el valor en los autocompletados
    OrigenDestinoComponent.prototype.displayFn = function (elemento) {
    ...
    OrigenDestinoComponent.prototype.displayFa = function (elemento) {
        if (elemento != undefined) {
    ...
    OrigenDestinoComponent.prototype.manejarEvento = function (keycode) {
    ...
    OrigenDestinoComponent = __decorate([
        core_1.Component({
            selector: 'app-origen-destino',
            templateUrl: './origen-destino.component.html',
            styleUrls: ['./origen-destino.component.css']
        }),
        __metadata("design:paramtypes", [origen_destino_service_1.OrigenDestinoService, subopcion_pestania_service_1.SubopcionPestaniaService,
            provincia_service_1.ProvinciaService, app_component_1.AppComponent, ngx_toastr_1.ToastrService])
    ], OrigenDestinoComponent);
    return OrigenDestinoComponent;
}());
exports.OrigenDestinoComponent = OrigenDestinoComponent;
//# sourceMappingURL=origen-destino.component.js.map