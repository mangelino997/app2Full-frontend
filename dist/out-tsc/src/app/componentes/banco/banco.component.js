...
var BancoComponent = /** @class */ (function () {
    //Constructor
    function BancoComponent(servicio, subopcionPestaniaService, appComponent, toastr) {
        var _this = this;
    ...
    BancoComponent.prototype.cambioAutocompletado = function (elemento) {
        this.formulario.patchValue(elemento);
    };
    //Formatea el valor del autocompletado
    BancoComponent.prototype.displayFn = function (elemento) {
    ...
    BancoComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    BancoComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    BancoComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    BancoComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    BancoComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Agrega un registro
    BancoComponent.prototype.agregar = function () {
        var _this = this;
    ...
    BancoComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    BancoComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece los campos formularios
    BancoComponent.prototype.reestablecerFormulario = function (id) {
        this.formulario.reset();
    ...
    BancoComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    //Manejo de colores de campos y labels con patron erroneo
    BancoComponent.prototype.validarPatron = function (patron, campo) {
    ...
    BancoComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.patchValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    BancoComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.patchValue(elemento);
    };
    //Maneja los evento al presionar una tacla (para pestanias y opciones)
    BancoComponent.prototype.manejarEvento = function (keycode) {
    ...
    BancoComponent = __decorate([
        ...
        __metadata("design:paramtypes", [banco_service_1.BancoService, subopcion_pestania_service_1.SubopcionPestaniaService,
