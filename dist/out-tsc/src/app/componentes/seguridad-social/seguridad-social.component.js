...
var SeguridadSocialComponent = /** @class */ (function () {
    //Constructor
    function SeguridadSocialComponent(servicio, subopcionPestaniaService, appComponent, toastr) {
        var _this = this;
    ...
    SeguridadSocialComponent.prototype.ngOnInit = function () {
    ...
    SeguridadSocialComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    SeguridadSocialComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    SeguridadSocialComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    SeguridadSocialComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    SeguridadSocialComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Agrega un registro
    SeguridadSocialComponent.prototype.agregar = function () {
        var _this = this;
    ...
    SeguridadSocialComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    SeguridadSocialComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece el formulario
    SeguridadSocialComponent.prototype.reestablecerFormulario = function (id) {
    ...
    SeguridadSocialComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    //Manejo de colores de campos y labels con patron erroneo
    SeguridadSocialComponent.prototype.validarPatron = function (patron, campo) {
    ...
    SeguridadSocialComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    SeguridadSocialComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Define como se muestra los datos en el autcompletado
    SeguridadSocialComponent.prototype.displayFn = function (elemento) {
    ...
    SeguridadSocialComponent.prototype.manejarEvento = function (keycode) {
    ...
    SeguridadSocialComponent = __decorate([
        core_1.Component({
            selector: 'app-seguridad-social',
            templateUrl: './seguridad-social.component.html',
            styleUrls: ['./seguridad-social.component.css']
        }),
        __metadata("design:paramtypes", [seguridad_social_service_1.SeguridadSocialService, subopcion_pestania_service_1.SubopcionPestaniaService,
            app_component_1.AppComponent, ngx_toastr_1.ToastrService])
    ], SeguridadSocialComponent);
    return SeguridadSocialComponent;
}());
exports.SeguridadSocialComponent = SeguridadSocialComponent;
//# sourceMappingURL=seguridad-social.component.js.map