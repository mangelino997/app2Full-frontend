...
var SexoComponent = /** @class */ (function () {
    //Constructor
    function SexoComponent(servicio, subopcionPestaniaService, appComponent, toastr) {
        var _this = this;
    ...
    SexoComponent.prototype.ngOnInit = function () {
    ...
    SexoComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    SexoComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    SexoComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    SexoComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    SexoComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Agrega un registro
    SexoComponent.prototype.agregar = function () {
        var _this = this;
    ...
    SexoComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    SexoComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece el formulario
    SexoComponent.prototype.reestablecerFormulario = function (id) {
    ...
    SexoComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    ;
    //Muestra en la pestania buscar el elemento seleccionado de listar
    SexoComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    SexoComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Define como se muestra los datos en el autcompletado
    SexoComponent.prototype.displayFn = function (elemento) {
    ...
    SexoComponent.prototype.manejarEvento = function (keycode) {
    ...
    SexoComponent = __decorate([
        core_1.Component({
            selector: 'app-sexo',
            templateUrl: './sexo.component.html',
            styleUrls: ['./sexo.component.css']
        }),
        __metadata("design:paramtypes", [sexo_service_1.SexoService, subopcion_pestania_service_1.SubopcionPestaniaService,
            app_component_1.AppComponent, ngx_toastr_1.ToastrService])
    ], SexoComponent);
    return SexoComponent;
}());
exports.SexoComponent = SexoComponent;
//# sourceMappingURL=sexo.component.js.map