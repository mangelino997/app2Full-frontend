...
var venta_tipo_item_1 = require("src/app/modelos/venta-tipo-item");
var VentaTipoComponent = /** @class */ (function () {
    // public compereFn:any;
    //Constructor
    function VentaTipoComponent(afipConceptosServicio, servicio, ventaConcepto, appComponent, subopcionPestaniaService, tipoComprobanteServicio, toastr) {
        var _this = this;
        this.afipConceptosServicio = afipConceptosServicio;
    ...
    VentaTipoComponent.prototype.ngOnInit = function () {
    ...
    VentaTipoComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Obtiene la lista completa de tipos de Comprobantes
    VentaTipoComponent.prototype.listarTiposComprobantes = function () {
        var _this = this;
    ...
    //Obtiene los conceptos de Afip
    VentaTipoComponent.prototype.listarAfipConcepto = function () {
        var _this = this;
        this.afipConceptosServicio.listar().subscribe(function (res) {
            _this.afipConceptos = res.json();
        }, function (err) {
            console.log(err);
        });
    };
    //Funcion para establecer los valores de las pestañas
    VentaTipoComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    VentaTipoComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    VentaTipoComponent.prototype.establecerEstadoCampos = function (estado) {
        if (estado) {
    ...
    VentaTipoComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    //Agrega un registro
    VentaTipoComponent.prototype.agregar = function () {
        var _this = this;
    ...
    VentaTipoComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    VentaTipoComponent.prototype.eliminar = function () {
        console.log();
    };
    //Obtiene el siguiente id
    VentaTipoComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    VentaTipoComponent.prototype.reestablecerFormulario = function (id) {
        this.formulario.reset();
    ...
    VentaTipoComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    ;
    //Muestra en la pestania buscar el elemento seleccionado de listar
    VentaTipoComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.patchValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    VentaTipoComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.patchValue(elemento);
    };
    //Define como se muestra los datos en el autcompletado
    VentaTipoComponent.prototype.displayFn = function (elemento) {
    ...
    VentaTipoComponent.prototype.compararFn = function (a, b) {
        if (a != null && b != null) {
            return a.id === b.id;
        }
    };
    //Maneja los evento al presionar una tacla (para pestanias y opciones)
    VentaTipoComponent.prototype.manejarEvento = function (keycode) {
    ...
    VentaTipoComponent = __decorate([
        core_1.Component({
            selector: 'app-venta-tipo',
            templateUrl: './venta-tipo.component.html',
            styleUrls: ['./venta-tipo.component.css']
        }),
        __metadata("design:paramtypes", [afip_concepto_service_1.AfipConceptoService, venta_tipo_item_service_1.VentaTipoItemService, venta_tipo_item_1.VentaTipoItem, app_component_1.AppComponent,
            subopcion_pestania_service_1.SubopcionPestaniaService, tipo_comprobante_service_1.TipoComprobanteService, ngx_toastr_1.ToastrService])
    ], VentaTipoComponent);
    return VentaTipoComponent;
}());
exports.VentaTipoComponent = VentaTipoComponent;
//# sourceMappingURL=venta-tipo.component.js.map