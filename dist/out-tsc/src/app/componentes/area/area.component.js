...
var AreaComponent = /** @class */ (function () {
    //Constructor
    function AreaComponent(servicio, subopcionPestaniaService, appComponent, toastr) {
        var _this = this;
    ...
    AreaComponent.prototype.cambioAutocompletado = function (elemento) {
        this.formulario.patchValue(elemento);
    };
    //Formatea el valor del autocompletado
    AreaComponent.prototype.displayFn = function (elemento) {
    ...
    AreaComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    AreaComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    AreaComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    AreaComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    AreaComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Agrega un registro
    AreaComponent.prototype.agregar = function () {
        var _this = this;
    ...
    AreaComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    AreaComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece los campos formularios
    AreaComponent.prototype.reestablecerFormulario = function (id) {
        this.formulario.reset();
    ...
    AreaComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    ;
    //Muestra en la pestania buscar el elemento seleccionado de listar
    AreaComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.patchValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    AreaComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.patchValue(elemento);
    };
    //Maneja los evento al presionar una tacla (para pestanias y opciones)
    AreaComponent.prototype.manejarEvento = function (keycode) {
    ...
    AreaComponent = __decorate([
        ...
        __metadata("design:paramtypes", [area_service_1.AreaService, subopcion_pestania_service_1.SubopcionPestaniaService,
