...
var ObraSocialComponent = /** @class */ (function () {
    //Constructor
    function ObraSocialComponent(servicio, subopcionPestaniaService, appComponent, toastr) {
        var _this = this;
    ...
    ObraSocialComponent.prototype.ngOnInit = function () {
        ...
        this.formulario = new forms_1.FormGroup({
            ...
            codigoAfip: new forms_1.FormControl('', [forms_1.Validators.required, forms_1.Validators.min(1), forms_1.Validators.maxLength(6)]),
    ...
    ObraSocialComponent.prototype.establecerValoresPestania = function (nombrePestania, autocompletado, soloLectura, boton, componente) {
    ...
    ObraSocialComponent.prototype.seleccionarPestania = function (id, nombre, opcion) {
    ...
    ObraSocialComponent.prototype.accion = function (indice) {
        switch (indice) {
            case 1:
                this.agregar();
                break;
    ...
    ObraSocialComponent.prototype.obtenerSiguienteId = function () {
        var _this = this;
    ...
    ObraSocialComponent.prototype.listar = function () {
        var _this = this;
    ...
    //Agrega un registro
    ObraSocialComponent.prototype.agregar = function () {
        var _this = this;
    ...
    ObraSocialComponent.prototype.actualizar = function () {
        var _this = this;
    ...
    //Elimina un registro
    ObraSocialComponent.prototype.eliminar = function () {
        console.log();
    };
    //Reestablece el formulario
    ObraSocialComponent.prototype.reestablecerFormulario = function (id) {
    ...
    ObraSocialComponent.prototype.cambioCampo = function (id, label) {
        document.getElementById(id).classList.remove('is-invalid');
        document.getElementById(label).classList.remove('label-error');
    };
    //Manejo de colores de campos y labels con patron erroneo
    ObraSocialComponent.prototype.validarPatron = function (patron, campo) {
    ...
    ObraSocialComponent.prototype.activarConsultar = function (elemento) {
        this.seleccionarPestania(2, this.pestanias[1].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra en la pestania actualizar el elemento seleccionado de listar
    ObraSocialComponent.prototype.activarActualizar = function (elemento) {
        this.seleccionarPestania(3, this.pestanias[2].nombre, 1);
        this.autocompletado.setValue(elemento);
        this.formulario.setValue(elemento);
    };
    //Muestra el valor en los autocompletados
    ObraSocialComponent.prototype.displayFn = function (elemento) {
    ...
    ObraSocialComponent.prototype.manejarEvento = function (keycode) {
    ...
    ObraSocialComponent = __decorate([
        ...
        __metadata("design:paramtypes", [obra_social_service_1.ObraSocialService, subopcion_pestania_service_1.SubopcionPestaniaService,
            app_component_1.AppComponent, ngx_toastr_1.ToastrService])
    ], ObraSocialComponent);
    return ObraSocialComponent;
}());
exports.ObraSocialComponent = ObraSocialComponent;
//# sourceMappingURL=obra-social.component.js.map